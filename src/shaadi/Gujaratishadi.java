...
public class Gujaratishadi {
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		driver.findElement(By.xpath("//input[@name='email']")).sendKeys("test5497@gmail.com");
		...
		WebElement community = driver.findElement(By.xpath("//div[contains(text(),'Gujarati')]"));
		String communityName=community.getText();
		System.out.println("getText is: "+communityName);
		if(communityName.equals("Gujarati"))
		{
